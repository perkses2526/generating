...
";
        ...
        $sql = "SELECT DISTINCT 
            ...
            d.org_code, 
            count(distinct case when dd.date_disposed is null then d.docket_id end) as pending_cases,
            count(distinct d.docket_id) as `Total cases`
        from 
            cases c 
            join 
        ...
        LEFT JOIN param_disposition_types pdt ON pdt.disposition_type_id = dd.disposition_type_id
        left join ects_core.users as u on c.process_by = u.user_id
        WHERE
...
;";
		...
		COUNT(d.docket_number) AS total,
