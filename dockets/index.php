...
<main id="main" class="main">
  <div class="text-end col-auto">
    <div class="btn-group">
      <button class="btn btn-warning btn-sm" onclick="datatable_to_excel('maintb', 'docketstb');" title="Export all data"><i class="bi bi-file-spreadsheet-fill"></i></button>
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="../dockets/">Home</a></li>
        <li class="breadcrumb-item active">Dockets</li>
      </ol>
    </nav>
  </div>
